...
- **`CHOOSE_SKILL` is declarable from JSON**, with `from` defaulting to all eighteen skills — the half-elf's two, a feat's three. The wizard's picker greys out skills the character already has.
